...
import { setAuth, setSelectedSchool, setSchools } from "../../../../redux/action";
...
export function AuthPage() {
  ...
  const submitLogin = () => {
    ...
    if (!loginNameError && !passwordError) {
      ...
      fetchRequestLogin("auth/login", "POST", qs.stringify(params)).then(
        (response) => {
          if (response.success) {
      ...
      <div className="login-content login-content-form pt60">
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ paddingLeft: 20, paddingRight: 20 }}>
            ...
            <div className="text-center mt30">{msAuth()}</div>
        ...
        <div className="social text-center mt30">
          ...
          >
            <a
              href="https://www.facebook.com/msue.education"
              target="_blank"
          ...
          <Tooltip title={t("social.twitter")} aria-label={t("social.twitter")}>
            <a
              href="https://twitter.com/msue2012"
              target="_blank"
          ...
          <Tooltip title={t("social.youtube")} aria-label={t("social.youtube")}>
            <a
              href="https://www.youtube.com/channel/UCOhjjoByTlO3ERreW7hRdGg/videos"
              target="_blank"
    ...
    <React.Fragment>
      <section id="authWrapper">
        <Hidden smDown>
          <div className="login-content-fixed row">
            ...
            <div className="login-content-image col-md-7 text-center pt60">
              <img
                src={toAbsoluteUrl("/media/logos/auth_logo_white.png")}
                className="img-responsive"
        ...
        <div className="login-content-absolute row">
          <Hidden smDown>
            <div className="col-md-5">{renderLoginForm()}</div>
          </Hidden>
          <Hidden mdUp>
            <div
