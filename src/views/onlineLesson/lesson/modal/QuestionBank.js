...
import { courseQuestionSelect, examQuestionIndex } from 'utils/fetchRequest/Urls';
import showMessage from "modules/message";
import FilterIcon from "cs-line-icons/custom/FilterIcon";
import Question from "../../../onlineExam/questions/question"
...
export default function QuestionBankModal({
    ...
    const handleProceedButton = () => {
        ...
        setLoading(true)
        fetchRequest(courseQuestionSelect, 'POST', params)
            .then((res) => {
                setLoading(false)
                if (res.success) {
                    if (!isActive) {
