...
import { movementBetweenView } from 'utils/fetchRequest/Urls'
...
const view = ({ onClose, id }) => {
    ...
    const [movement, setMovement] = useState(id)

    useEffect(() => {

        // setLoading(true)
        // fetchRequest(movementBetweenView, 'POST', { movement: id })
        //     .then((res) => {
        //         if (res.success) {
