        ...
        >
            <Modal.Header closeButton style={{padding: '1rem'}}>
                <Modal.Title className="modal-title d-flex flex-row justify-content-between w-100">
                    {translations(locale)?.teacher?.change_login_name_staff}
                </Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <p style={{ color: '#848691', fontSize: '0.8937rem' }} className='pb-4 pl-4'>{translations(locale)?.teacher?.change_login_name_description_staff}</p>
