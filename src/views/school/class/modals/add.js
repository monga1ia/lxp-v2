                                    ...
                                    <thead>
                                        <tr>
                                            <th style={{ color: '#575962', fontSize: '12px' }} className='text-left pl-4'>
                                                {t('className').toUpperCase() || null}
                                            </th>
                                            <th style={{ color: '#575962', fontSize: '12px' }} className='text-left pl-4'>
                                                {t('group.title').toUpperCase() || null}
                                            </th>
                                            <th style={{ color: '#575962', fontSize: '12px' }} className='text-left pl-4'>
                                                {t('group.class_teacher').toUpperCase() || null}
                                            </th>
                                            <th style={{ color: '#575962', fontSize: '12px' }} className='text-left pl-4'>
                                                {t('group.school_shift').toUpperCase() || null}
                                            </th>
                                            <th style={{ color: '#575962', fontSize: '12px' }} className='text-left pl-4'>
                                                {t('group.score_type').toUpperCase() || null}
                                            </th>
                                            <th style={{color: '#575962',fontSize: '12px'}} className='text-left pl-4'>
                                                {translations(locale).esis.class_id.toUpperCase() || null}
                                            </th>
                                            <th style={{ color: '#575962', fontSize: '12px' }} className='text-left pl-4'>
                                                {t('group.classroom').toUpperCase() || null}
                                            </th>
                                            <th width="40" />
                                        </tr>
                                    </thead>
