...
import { examTemplateQuestions, examTemplateQuestionCreateFromOtherVariant } from 'utils/fetchRequest/Urls';
...
export default function QuizAddFromVariant({ 
    ...
    const saveButtonHandler = () => {
        ...
        setLoading(true)
        fetchRequest(examTemplateQuestionCreateFromOtherVariant, 'POST', params)
            .then((res) => {
                setLoading(false)
                if (res.success) {
                    onDoneAction()
