        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              ...
              />
              <div className="mb-1 text-muted sh-7">
                Pie fruitcake jelly beans. Candy tootsie chocolate croissant
                jujubes icing macaroon croissant.
              </div>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              ...
              />
              <div className="mb-1 text-muted sh-7">
                Donut halvah cotton candy cake dessert. Wafer jujubes
                gingerbread halvah.
              </div>
              <Row className="g-0 align-items-center mb-1">
                <Col xs="auto">
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              ...
              />
              <div className="mb-1 text-muted sh-7">
                Marshmallow liquorice cake liquorice jujubes bear claw. Muffin
                bear claw bear claw.
              </div>
              <Row className="g-0 align-items-center mb-1">
                <Col xs="auto">
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              ...
              />
              <div className="mb-1 text-muted sh-7">
                Gummies sugar plum cake pie muffin danish bear claw bear claw
                jelly-o. Chocolate sugar icing biscuit.
              </div>
              <Row className="g-0 align-items-center mb-1">
                <Col xs="auto">
                  <div className="sw-3 sh-4 d-flex justify-content-center align-items-center">
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              ...
              />
              <div className="mb-1 text-muted sh-7">
                Liquorice chocolate bar toffee gummi bears. Muffin sweet tootsie
                roll tart sugar plum muffin.
              </div>
              <Row className="g-0 align-items-center mb-1">
                <Col xs="auto">
                  <div className="sw-3 sh-4 d-flex justify-content-center align-items-center">
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              ...
              />
              <div className="mb-1 text-muted sh-7">
                Danish brownie fruitcake tootsie roll donut bonbon ice cream.
                Sweet roll candy chocolate.
              </div>
              <Row className="g-0 align-items-center mb-1">
                <Col xs="auto">
                  <div className="sw-3 sh-4 d-flex justify-content-center align-items-center">
          ...
          <Card className="h-100">
            <Card.Body className="text-center">
              ...
              <div className="mb-1 text-muted sh-7">
                ...
                lemon drops tootsie roll bear claw.
              </div>
              <Row className="g-0 align-items-center mb-1">
                <Col xs="auto">
                  <div className="sw-3 sh-4 d-flex justify-content-center align-items-center">
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              <div className="sw-13 position-relative mb-3 mx-auto">
                <img
                  src="/img/profile/profile-10.webp"
                  className="img-fluid rounded-xl"
                  alt="thumb"
                />
              </div>
              ...
              />
              <div className="mb-1 text-muted sh-7">
                Bonbon candy canes oat cake. Pudding pastry icing. Sweet sugar
                plum liquorice gingerbread.
              </div>
              <Row className="g-0 align-items-center mb-1">
                <Col xs="auto">
                  <div className="sw-3 sh-4 d-flex justify-content-center align-items-center">
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              ...
              />
              <div className="mb-1 text-muted sh-7">
                Halvah cheesecake tootsie roll gingerbread chocolate fruitcake.
                Candy canes lemon drops.
              </div>
              <Row className="g-0 align-items-center mb-1">
                <Col xs="auto">
                  <div className="sw-3 sh-4 d-flex justify-content-center align-items-center">
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="text-center">
              ...
              />
              <div className="mb-1 text-muted sh-7">
                Chocolate bar chocolate bar tart cotton tart pudding lollipop.
                Chupa chups croissant.
              </div>
              <Row className="g-0 align-items-center mb-1">
                <Col xs="auto">
                  <div className="sw-3 sh-4 d-flex justify-content-center align-items-center">
