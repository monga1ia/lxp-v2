            ...
            <Row className="g-0 h-auto sh-lg-12">
              <Col xs="12" lg="auto" className="h-100">
                <img
                  ...
                  alt="course"
                  className="card-img card-img-horizontal-lg sh-18 sw-lg-16 h-lg-100"
                />
              </Col>
                      ...
                      <Row className="gx-2 align-items-center">
                        ...
                        <Col lg="12" className="col">
                          <Row className="g-0">
                            ...
                            <Col xs="auto" lg="12">
                              <div className="sh-4 d-flex align-items-center text-alternate lg-end">
                                A
                              </div>
                            </Col>
                          </Row>
