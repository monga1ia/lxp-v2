...
const register = ({ onClose, onSubmit }) => {
    ...
    // useEffect(() => {
    //     setLoading(true)
    //     fetchRequest(teacherExcuseReasonSubmit, 'POST', { menu: 'manager' })
    //         .then((res) => {
    //             if (res.success) {
    ...
    const handleClassChange = value => {
        ...
        // fetchRequest(teacherExcuseReasonSubmit, 'POST', { class: value, menu: 'manager' })
        //     .then((res) => {
        //         if (res.success) {
    ...
    const handleStudentChange = value => {
        ...
        // fetchRequest(teacherExcuseReasonSubmit, 'POST', { student: value, menu: 'manager' })
        //     .then((res) => {
        //         if (res.success) {
